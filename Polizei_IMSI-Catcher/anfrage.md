...
1. Ist Österreich im Besitz vom "IMSI - Catchern" oder ähnlichen Geräten zur Überwachung vom Mobiltelefonen?
  a) Falls ja:
    i. wann,
    ii. wieviele,
    iii. und um welchen Preis wurden diese Geräte angeschafft?
...
9. Werden bei Einsätzen solcher Geräte auch Daten von Personen ausser der/den Zielperson/en gesammelt? 
  a) Falls ja:
    i. Wodurch ist diese Sammlung von Daten über unbeteiligte Personen rechtlich gedeckt?
    ii. Werden Maßnahmen getroffen um die Menge der Daten von unbeteiligten Personen möglichst gering zu halten? Falls ja, welche?
    iii. Werden Daten über unbeteiligte Personen gesondert behandelt?
